...
export default function DueDiligence() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const storageRef = ref(storage, `dueDiligenceDocuments/${image.name}`);
      ...
      uploadTask.on(
        ...
        async () => {
          ...
          toast.success('Due Diligence submitted successfully!');
  ...
  return (
    <div className="h-[100vh] flex justify-center items-center">
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-md shadow-md w-[90%] md:w-[50%]">
        ...
        <label className="block mb-2">Image of Due Diligence Document</label>
        <input 
          type="file" 
